...
class BookApiRouter @Inject() (
  ...
  override def routes: Routes = {
    ...
    case GET(p"/site/chapters/getall/$bookId") => chapterController.getBookChapters(bookId)
    ...
    case POST(p"/site/chapter/delete") => chapterController.delete
      ...
      // For Sections
    case GET(p"/site/sections/getall/$chapterId") => sectionController.getChapterSections(chapterId)
    ...
    case POST(p"/site/section/delete") => sectionController.delete
      ...
      // For Subsections
    case GET(p"/site/subsections/getall/$sectionId") => subsectionController.getSectionSubsections(sectionId)
